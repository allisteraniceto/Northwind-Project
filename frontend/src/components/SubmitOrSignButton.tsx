...
export default function SubmitButton(props: SubmitButtonProps) {
  ...
  const submitPostRequest = async () => {
    try {
      //make post request upon clicking of 'submit' or 'sign' button

      let response;
      if (props.buttonType == "submit") {
        response = await axios.post(
          `${config.apiUrl}/SubmissionForm/HandleSubmission`,
          props.formType,
          {
            headers: {
              "Content-Type": "application/json",
        ...
        response = await axios.post(
          `${config.apiUrl}/SubmissionForm/HandleSignature`,
          props.formType,
          {
            headers: {
              "Content-Type": "application/json",
  ...
  if (props.buttonType == "submit") {
    ...
    if (props.formType === "employee") {
      // if this submit button is on the EmployeeReviewFormPage
      ...
      // if this submit button is on the ManagerReviewFormPage
